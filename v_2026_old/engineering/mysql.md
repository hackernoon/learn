...
### [2. How to Install MySQL 8 on macOS Using Homebrew](https://hackernoon.com/how-to-install-mysql-8-on-macos-using-homebrew)
...
### [3. How to Сompress a mysqldump Backup Using Gzip](https://hackernoon.com/how-to-sompress-a-mysqldump-backup-using-gzip-901v3wb6)
...
### [9. Go: Handling JSON in MySQL](https://hackernoon.com/go-handling-json-in-mysql-su2h31wg)
![](https://cdn.hackernoon.com/images/pbHhPcoSDWY470tliHRnqSk6GMX2-sy4f31uj.jpeg)


### [10. Fortifying Postgres With Byzantine Fault Tolerance](https://hackernoon.com/fortifying-postgres-with-byzantine-fault-tolerance)
...
### [11. Unlocking the Power of JSON in MySQL: Tips and Tricks](https://hackernoon.com/unlocking-the-power-of-json-in-mysql-tips-and-tricks)
...
### [12. How to Efficiently Generate Test Data With SQL](https://hackernoon.com/how-to-efficiently-generate-test-data-with-sql)
...
### [13. How to Detect and Delete Emojis in Golang](https://hackernoon.com/how-to-detect-and-delete-emojis-in-golang)
...
### [14. What Is the Difference Between Enum, Varchar and Int Data Types in MySQL](https://hackernoon.com/what-is-the-difference-between-enum-varchar-and-int-data-types-in-mysql)
...
### [15. Unexpected Discoveries in TypeORM 0.3.11](https://hackernoon.com/unexpected-discoveries-in-typeorm-0311)
...
### [16. How to Deploy Strapi v4 on the DigitalOcean App Platform with MySQL Database](https://hackernoon.com/how-to-deploy-strapi-v4-on-the-digitalocean-app-platform-with-mysql-database)
...
### [17. GitHub Actions CI config for MySQL, Redis, Elasticsearch in Ruby on Rails project with RSpec tests](https://hackernoon.com/github-actions-ci-config-for-mysql-redis-elasticsearch-in-ruby-on-rails-project-with-rspec-tests-cbj346d)
...
### [18. 5 Best Courses to Learn MySQL Database for Beginners](https://hackernoon.com/5-best-courses-to-learn-mysql-database-for-beginners)
...
### [19. Top 10 Websites to Learn SQL and Database Online](https://hackernoon.com/top-10-websites-to-learn-sql-and-database-online)
...
### [23. Using Git Hooks with MySQL](https://hackernoon.com/using-git-hooks-with-mysql)
...
### [24. MySQL Loose Scan Optimization: A Comparative Performance Evaluation Against PostgreSQL and MSSQL](https://hackernoon.com/mysql-loose-scan-optimization-a-comparative-performance-evaluation-against-postgresql-and-microsoft)
...
### [25. Navigating MySQL Data Types: Sets and Enums](https://hackernoon.com/navigating-mysql-data-types-sets-and-enums)
...
### [26. How to Create and Connect a MySQL Database to PHP Files Using cPanel](https://hackernoon.com/how-to-create-and-connect-a-mysql-database-to-php-files-using-cpanel)
...
### [27. Integrate Java Database Versioning with Liquibase using MySQL [A Step by Step Guide]](https://hackernoon.com/integrate-java-database-versioning-with-liquibase-using-mysql-a-step-by-step-guide-n8b23aw5)
...
### [28. Express-js Boilerplate with User Authentication](https://hackernoon.com/express-js-boilerplate-with-user-authentication-ch5032a3)
...
### [29. How to Stream Data from MySQL to Postgres](https://hackernoon.com/how-to-stream-data-from-mysql-to-postgres)
...
### [30. A Prisma ORM Review](https://hackernoon.com/a-prisma-orm-review)
...
### [31. Is MariaDB simply a fork of MySQL?](https://hackernoon.com/is-mariadb-simply-a-fork-of-mysql)
...
### [32. Build a Movie Streaming App Like Netflix Using Node.js, MySQL, and Deploy on Aptible](https://hackernoon.com/build-a-movie-streaming-app-like-netflix-using-nodejs-mysql-and-deploy-on-aptible)
...
### [33. 2019 Database Trends – SQL vs. NoSQL, Top Databases, Single vs. Multiple Database Use](https://hackernoon.com/2019-database-trends-sql-vs-nosql-top-databases-single-vs-multiple-database-use-ly1cu3z18)
...
### [34. Navigating MySQL data types: date and time](https://hackernoon.com/navigating-mysql-data-types-date-and-time)
...
### [35. PostgreSQL or MySQL: What Should I Choose for My Full-Stack Project?](https://hackernoon.com/postgresql-or-mysql-what-should-i-choose-for-my-full-stack-project)
...
### [36. Creating a Simple Business Directory using CodeIgniter and MySQL](https://hackernoon.com/creating-a-simple-business-directory-using-codeigniter-and-mysql-fo5t3y17)
...
### [37. Principles of a Clean Relational Database](https://hackernoon.com/principles-of-a-clean-relational-database)
...
### [38. How to model an efficient database for your application](https://hackernoon.com/how-to-model-an-efficient-database-for-your-application-c1aeb26636d4)
...
### [40. Navigating MySQL data types: numeric](https://hackernoon.com/navigating-mysql-numeric-data-types)
...
### [41. Mastering Java JDBC CRUD Operations in Eclipse Using MySQL](https://hackernoon.com/mastering-java-jdbc-crud-operations-in-eclipse-using-mysql)
...
### [42. How To Create Secure Registration Flow with PHP and Password Hashing](https://hackernoon.com/how-to-create-secure-registration-flow-with-php-and-password-hashing-nw1b3t1z)
...
### [43. The Power of Functional Indexes in MySQL: A Comprehensive Guide](https://hackernoon.com/the-power-of-functional-indexes-in-mysql-a-comprehensive-guide)
![](https://cdn.hackernoon.com/images/XIlys8PrM8eJ7n0qjETjuC0lbkB2-2l832rf.jpeg)
This article explores the concept and benefits of functional indexes in MySQL.

### [44. Dockerize Your Laravel Project in a Jiffy](https://hackernoon.com/dockerize-your-laravel-project-in-a-jiffy)
...
### [45. Hosting Provider Cloud Clusters Inc. Potentially Exposed 63M Records](https://hackernoon.com/hosting-provider-cloud-clusters-inc-potentially-exposed-63m-records-iq2e3w4w)
...
### [46. Installing phpMyAdmin for Easy MySQL Administration [A How-To Guide]](https://hackernoon.com/installing-phpmyadmin-for-easy-mysql-administration-a-how-to-guide-9p1b324u)
...
### [47. Decoding MySQL EXPLAIN Query Results for Better Performance](https://hackernoon.com/decoding-mysql-explain-query-results-for-better-performance)
...
### [48. Does MariaDB Depend on MySQL?](https://hackernoon.com/does-mariadb-depend-on-mysql)
...
### [49. Jython: The Love Child of Python and Java](https://hackernoon.com/jython-the-love-child-of-python-and-java-bz2h3520)
...
### [51. Reduce MySQL CPU Usage Through Dynamic Binary Optimisation](https://hackernoon.com/reduce-mysql-cpu-usage-through-dynamic-binary-optimisation-fw6t32zt)
...
### [59. Top 3 Databases Every New Developer Should Know](https://hackernoon.com/top-3-databases-every-new-developer-should-know)
...
### [60. [Tutorial] Top 5 Ways to Query your Relational Database in JavaScript [Part 1]](https://hackernoon.com/tutorial-top-5-ways-to-query-your-relational-database-in-javascript-part-1-v1x3uy0)
...
### [61. Make Your Application Scalable Optimizing the ORM Performance](https://hackernoon.com/make-your-application-scalable-optimizing-the-orm-performance-pq8q3yn2)
![](images/2c1h32pq.jpg)
...
### [62. RocksDB Is Steadily Eating the Database World](https://hackernoon.com/rocksdb-is-steadily-eating-the-database-world-na6132ax)
...
### [83. A Guide to Understanding Indexes in MySQL](https://hackernoon.com/a-guide-to-understanding-indexes-in-mysql)
...
### [84. How to Connect With External MySQL Servers (Part 1: Select Operations)](https://hackernoon.com/how-to-connect-with-external-mysql-servers-part-1-select-operations-o52c34wl)
...
### [85. PHP CRUD Generator – Instantly Build Admin Panels from Your Database](https://hackernoon.com/php-crud-generator-instantly-build-admin-panels-from-your-database)
...
### [86. Apache APISIX Without etcd?](https://hackernoon.com/apache-apisix-without-etcd)
...
### [95. SQL Data Modification Commands With Examples: A Fast and Easy Guide](https://hackernoon.com/sql-data-modification-commands-with-examples-a-fast-and-easy-guide)
![](https://cdn.hackernoon.com/images/xckvxyvNs3ej2QPeVNul88CL5jv1-c203ez4.png)
In this article, we’ll explore these commands with practical examples.

### [96. My Personal Guide to SQL Window Functions (Part 2) ](https://hackernoon.com/my-personal-guide-to-sql-window-functions-part-2)
...
### [106. How to Migrate Your Existing MySQL Database to Vitess](https://hackernoon.com/how-to-migrate-your-existing-mysql-database-to-vitess)

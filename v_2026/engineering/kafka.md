...
### [2. Kafka vs RabbitMQ: Find the Best Fit for Your Project](https://hackernoon.com/kafka-vs-rabbitmq-find-the-best-fit-for-your-project)
...
### [3. Handling Custom Type Mapping in Kafka Listeners for Messages with "TypeId" Header](https://hackernoon.com/handling-custom-type-mapping-in-kafka-listeners-for-messages-with-typeid-header)
...
### [4. How to Move End-to-end Encrypted Data Through Kafka](https://hackernoon.com/how-to-move-end-to-end-encrypted-data-through-kafka)
...
### [5. How to Consume Kafka Messages With NestJS](https://hackernoon.com/how-to-consume-kafka-messages-with-nestjs)
...
### [6. How to Stream From a REST API Using Kafka Connect](https://hackernoon.com/how-to-stream-from-a-rest-api-using-kafka-connect)
...
### [7. Real Time Data Processing: Easily Processing 10 Million Messages With Golang, Kafka and MongoDB](https://hackernoon.com/real-time-data-processing-easily-processing-10-million-messages-with-golang-kafka-and-mongodb)
...
### [8. Load Testing for High-Load Distributed Systems](https://hackernoon.com/load-testing-for-high-load-distributed-systems)
...
### [10. What The Heck is WarpStream?](https://hackernoon.com/what-the-heck-is-warpstream)
...
### [11. The System Design Cheat Sheet: Message Queues - ActiveMQ, RabbitMQ, Kafka, ZeroMQ](https://hackernoon.com/the-system-design-cheat-sheet-message-queues-activemq-rabbitmq-kafka-zeromq)
...
### [13. How to Authenticate Kafka Using Kerberos (SASL), Spark, and Jupyter Notebook](https://hackernoon.com/how-to-authenticate-kafka-using-kerberos-sasl-spark-and-jupyter-notebook-rwal35bx)
...
### [14. How to Execute a Scheduled Task in Keycloak on Startup](https://hackernoon.com/how-to-execute-a-scheduled-task-in-keycloak-on-startup)
...
### [15. Best Practices For Apache Kafka Configuration](https://hackernoon.com/best-practices-for-apache-kafka-configuration-maf31rn)
...
### [16. Kafka Basics and Core Concepts: Explained](https://hackernoon.com/kafka-basics-and-core-concepts-explained-dd1434dv)
...
### [17. Auto-generation of Documentation for Event-driven Architecture](https://hackernoon.com/auto-generation-of-documentation-for-event-driven-architecture)
...
### [18. Build your Own Live Chart With Deno, WebSockets, Chart.js and Materialize](https://hackernoon.com/build-your-own-live-chart-with-deno-websockets-chartjs-and-materialize)
...
### [19. Real-time Analytics and Data Processing with Kafka & Spark](https://hackernoon.com/real-time-analytics-and-data-processing-with-kafka-and-spark)
...
### [20. Apache Kafka: the Complicated Simplicity](https://hackernoon.com/apache-kafka-the-complicated-simplicity)
...
### [21. Stream and Display Data in Realtime with Materialize and Adonis](https://hackernoon.com/stream-and-display-data-in-realtime-with-materialize-and-adonis)
...
### [22. I Just Want to See It Work: Kafka Stream, C# Producer and Consumer](https://hackernoon.com/i-just-want-to-see-it-work-kafka-stream-c-producer-and-consumer)
...
### [23. Deploying Apache Kafka With Kubernetes](https://hackernoon.com/deploying-apache-kafka-with-kubernetes)
...
### [27. Jaeger Persistent Storage with Elasticsearch, Cassandra and Kafka](https://hackernoon.com/jaeger-persistent-storage-with-elasticsearch-cassandra-and-kafka-1h2w3tiw)
...
### [28. The Only Decoupling Checklist You Need To Know About](https://hackernoon.com/the-only-decoupling-checklist-you-need-to-know-about-e25232sz)
...
### [29. A Modern Stack to Build a Real-time Event-driven App](https://hackernoon.com/a-modern-stack-to-build-a-real-time-event-driven-app)
...
### [30. Apache Kafka Architecture 101: Internal Components and How They Work Together](https://hackernoon.com/apache-kafka-architecture-101-internal-components-and-how-they-work-together)
![](https://cdn.hackernoon.com/images/q6t9kyVqaAbMWMb9XJWOGmM6iV92-onh36ia.png)
In this article, you'll better understand all the components associated with Apache Kafka and how they work together.

### [31. Kafka Storage Design  -  Making File Systems Cool Again!](https://hackernoon.com/kafka-storage-design-making-file-systems-cool-again)
...
### [32. Lambda Architecture Speed Layer: Real-Time Visualization For Taxi [Part 1]](https://hackernoon.com/lambda-architecture-speed-layer-real-time-visualization-for-taxi-part-1-a31931tr)
...
### [33. Build a Live Dashboard with Materialize, Airbyte, MySQL and Redpanda/Kafka](https://hackernoon.com/build-a-live-dashboard-with-materialize-airbyte-mysql-and-redpandakafka)
![](https://cdn.hackernoon.com/images/da7H4NzOhAdhje46xkTgaLorF5m2-1993yzz.jpeg)


### [34. Record-Replay Strategy for Testing Event-Driven Architecture](https://hackernoon.com/record-replay-strategy-for-testing-event-driven-architecture)
...
### [36. Top Apache Kafka® Interview Questions for Juniors In 2023](https://hackernoon.com/top-apache-kafkar-interview-questions-for-juniors-in-2023)
...
### [44. Key Apache KafkaⓇ Concepts Every Dev Needs to Know](https://hackernoon.com/key-apache-kafka-concepts-every-dev-needs-to-know)
...
### [71. Kafka Gotchas](https://hackernoon.com/kafka-gotchas-l814320y)
...
### [75. Using KSQL Stream Processing & Real-Time Databases to Analyze Kafka Streaming Data [A How-To Guide]](https://hackernoon.com/using-ksql-stream-processing-and-real-time-databases-to-analyze-kafka-streaming-data-a-how-to-guide-804i327m)
![](https://cdn.hackernoon.com/images/vkn53y1i.jpg)
Intro

### [76. Architecting Resilient and Scalable Systems with Java, Kafka and AWS: A Case Study Approach](https://hackernoon.com/architecting-resilient-and-scalable-systems-with-java-kafka-and-aws-a-case-study-approach)
...
### [77. When ML Meets Microservices: Engineering for Scalability and Performance](https://hackernoon.com/when-ml-meets-microservices-engineering-for-scalability-and-performance)
...
### [78. Data Speedways: How Kafka Races Ahead in System Design](https://hackernoon.com/data-speedways-how-kafka-races-ahead-in-system-design)
...
### [86. Tips About Kafka Connect On Heroku You Can't Afford To Miss](https://hackernoon.com/tips-about-kafka-connect-on-heroku-you-cant-afford-to-miss-u8l3wzk)
...
### [87. Kuma 1.0 GA Released With 70+ New Features & Improvements](https://hackernoon.com/kuma-10-ga-released-with-70-new-features-and-improvements-avl3wwe)
...
### [88. The One Line of Code That Ate 12GB of SeaTunnel Kafka Connector's Memory in 5 Minutes](https://hackernoon.com/the-one-line-of-code-that-ate-12gb-of-seatunnel-kafka-connectors-memory-in-5-minutes)
